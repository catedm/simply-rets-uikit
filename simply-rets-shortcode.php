                      ...
                      <div class="uk-inline uk-width-1-5@s">
                        ...
                        <div class="uk-inline uk-width-1-5@s">
                          <div class="uk-width-1-1" uk-form-custom="target: true">
                              <!-- <button type="button" class="uk-button uk-button-default uk-width-1-1 property-search-page-form-dropdown-buttons">Type<span uk-icon="icon: triangle-down" style="position: relative; z-index: 2; right: 4px; top: 1px;"></span></button> -->
                              <!-- <span uk-icon="icon: triangle-down" style="position: absolute; z-index: 6; top: 12px; left: 30%; color: #000;"></span> -->
                              <select class="property-search-page-type-select" name="sr_ptype">
