...
HTML;
    ...
    public static function srResidentialDetailsGenerator( $listing ) {
        ...
        */
        ...
        $type = SimplyRetsApiHelper::srDetailsTable($listing_type);
        // bedrooms
        ...
        $style = SimplyRetsApiHelper::srDetailsTable($listing_style);
        // subdivision
...
HTML;
        ...
        <div uk-sticky>
          ...
          <div class="uk-grid-collapse uk-child-width-expand uk-text-center" style="border-bottom: 1px solid #D7D7D7;" uk-grid>
              <div>
                  <div class="uk-background-muted uk-padding-small sticky-top-info-single-property-cell" style="border-right: 1px solid #D7D7D7;">
                    <h3 class="uk-margin-remove sticky-top-info-single-property-cell">$listing_bedrooms - <small>Beds</small></h3>
                  </div>
              </div>
              <div>
                  <div class="uk-background-muted uk-padding-small sticky-top-info-single-property-cell" style="border-right: 1px solid #D7D7D7;">
                    <h3 class="uk-margin-remove sticky-top-info-single-property-cell">$primary_baths - <small>Baths</small></h3>
                  </div>
              </div>
              <div>
                ...
                <div>
                  ...
                  <div class="uk-padding-small">
                    ...
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>MLS#</div>
                      <div>#$listing_mlsid</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Price</div>
                      <div>$listing_price_USD</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Bedrooms</div>
                      <div>$listing_bedrooms</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Full Baths</div>
                      <div>$listing_bathsFull</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Half Baths</div>
                      <div>$listing_bathsHalf</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Square Footage</div>
                      <div>$area</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Year Built</div>
                      <div>$listing_yearBuilt</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Type</div>
                      <div>$type</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Style</div>
                      <div>$style</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Status</div>
                      <div>$listing_mls_status</div>
                    </div>
                    <h5 class="single-property-details">Community Information</h5>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Address</div>
                      <div>$listing_address</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Subdivision</div>
                      <div>$listing_subdivision</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>City</div>
                      <div>$listing_city</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>County</div>
                      <div>$listing_county</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>State</div>
                      <div>$listing_state</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Zip Code</div>
                      <div>$listing_postal_code</div>
                    </div>
                    <h5 class="single-property-details">Amenities</h5>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Parking Spaces</div>
                      <div>$listing_parking_spaces</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Parking</div>
                      <div>$listing_parking_description</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Garages Spaces</div>
                      <div>$listing_garage_spaces</div>
                    </div>
                    <h5 class="single-property-details">Amenities</h5>
                      $listing_association_amenities
                    <h5 class="single-property-details">Interior</h5>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Heating</div>
                      <div>$listing_heating</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader># of Fireplaces</div>
                      <div>$listing_fireplaces</div>
                    </div>
                    <h5 class="single-property-details">Interior Features</h5>
                      $listing_interiorFeatures
                    <h5 class="single-property-details">Exterior</h5>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Lot Description</div>
                      <div>$listing_lot_descrip</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Roof</div>
                      <div>$listing_roof</div>
                    </div>
                    <h5 class="single-property-details">School Information</h5>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>District</div>
                      <div>$listing_school_district</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Elementary</div>
                      <div>$listing_elementary</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>Middle</div>
                      <div>$listing_middle_school</div>
                    </div>
                    <div class="uk-grid-small" uk-grid>
                      <div class="uk-width-expand" uk-leader>High</div>
                      <div>$listing_high_school</div>
                    </div>
                  </div>
                </div>
              </div>
...
HTML;
    ...
    public static function resultDataColumnMarkup($val, $name, $reverse=false) {
        if( $val == "" ) {
            ...
            if($reverse == false) {
                $val = "<li><span uk-icon='icon: arrow-right;'></span> $val $name</li>";
            }
            else {
                $val = "<li><span uk-icon='icon: arrow-right;'></span> $name $val</li>";
            }
        }
        return $val;
    }
                ...
                <div class="uk-card uk-card-default">
                  <a href="$link">
                    ...
                    <div class="uk-card-body">
                      ...
                      <a href="$link" class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom">View Details</a>
                    </div>
                </div>
            </div>
